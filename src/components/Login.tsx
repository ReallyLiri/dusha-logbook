    ...
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 to-primary-50 flex items-center justify-center px-4 py-8">
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="bg-gradient-to-r from-primary-300 to-secondary-300 px-8 py-6">
            <div className="flex items-center justify-center space-x-2 space-x-reverse">
              <BookOpen className="h-8 w-8 text-white" />
              <h1 className="text-2xl font-bold text-white">דושה-לוגבוק</h1>
            </div>
            <p className="text-white/90 text-center mt-2 text-sm">
              עקוב אחר התובנות והצמיחה שלך
            </p>
          </div>
